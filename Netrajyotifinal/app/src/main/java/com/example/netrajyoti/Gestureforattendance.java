...
public class Gestureforattendance  extends GestureDetector.SimpleOnGestureListener {
    ...
    public Gestureforattendance(Activity context,
                               SimpleGestureFilter.SimpleGestureListener simpleGestureListener) {
